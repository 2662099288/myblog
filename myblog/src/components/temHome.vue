<template>
  <div class="home">
    <div v-for="(event,index) in eventList" :key="index" class="eventbox">
      ...
      <div class="topclass">{{event.class}} <div class="topclassjiao"></div></div>
      <p class="eventheader"><i class="iconfont">&#xe60a;</i> 发表于<i class="iconfont">&#xe61a;</i>{{event.time}}<i class="iconfont">&#xe643;</i>{{event.Browse_number}}次浏览</p>
